...
## Screenshots
![](https://github.com/user-attachments/assets/02c377f8-feaf-420f-9453-f172b10455aa)

## Setup
To send files, the program must be launched on two computers. On the sender's computer, drag and drop the required files or folder into the program interface and select a computer with the specified IP address — the file transfer will then begin.<br><br>
To avoid selecting the IP address manually, you can run the program with the following parameter:<br>
>"C:\Program Files\ShareFiles\ShareFiles.exe" -d 192.168.0.2

To prevent the program from asking for confirmation when receiving files, add the IP address in the settings.
